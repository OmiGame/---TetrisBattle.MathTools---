...
怪物属性配置: Dict[tuple[怪物职业, 怪物品质], 怪物属性比例和期望生命周期] = {
    ...
    (怪物职业.刺客, 怪物品质.精英): 怪物属性比例和期望生命周期(血量比例=0.45, DPS比例=0.55, 期望生存时间=6)
}